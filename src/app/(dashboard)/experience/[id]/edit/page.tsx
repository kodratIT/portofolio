...
import { getExperience, updateExperience } from "@/lib/firebase/experiences";
...
export default function EditExperiencePage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const loadExperience = async () => {
      try {
        ...
        if (data.userId !== user?.uid) {
          toast.error("You don't have permission to edit this experience");
          router.push("/experience");
          return;
        }
  ...
  const onSubmit = async (data: ExperienceFormValues) => {
    if (!user || !experience) {
      toast.error("Unable to update experience");
      return;
    }
